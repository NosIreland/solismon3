...
def main():
    ...
    """
    modbus = PySolarmanV5(
        "192.168.1.55", 123456789, port=8899, mb_slave_id=1, verbose=1
    )
    ...
    #print(modbus.read_holding_register_formatted(register_addr=33132, quantity=1, bitmask=0x2, bitshift=1))
